...
public class LuaService : MonoBehaviour
{
    ...
    IEnumerator LoadResourceCorotine(){
        UnityWebRequest request = UnityWebRequest.Get(@"http://localhost:52084/LuaTest.lua.txt");
        ...
        UnityWebRequest request2 = UnityWebRequest.Get(@"http://localhost:52084/LuaDispose.lua.txt");
